...
cmd="--directory $WORK_DIR --snakefile $SNAKEFILE --configfile $SAM_CONFIG --jobname {params.rulename}.{jobid} --nolock  --ri -k -p -T -j 3000 --resources DeFuse=4 --stats ngs_pipeline_${NOW}.stats"
